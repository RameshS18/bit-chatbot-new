...
const LandingPage = () => {
  ...
  if (showLogo) {
    return (
      <div className="fixed inset-0 flex items-center justify-center bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
        <div 
          className="text-5xl sm:text-7xl lg:text-8xl font-black tracking-wider text-white px-4 text-center animate-pulse"
          style={{
  ...
  if (showAdminLogin) {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-auto">
        <header className="fixed top-0 left-0 right-0 h-16 sm:h-20 bg-slate-900/90 border-b border-indigo-500/20 z-50 shadow-lg">
        ...
        <div className="min-h-screen flex items-center justify-center px-4 pt-20 sm:pt-24 pb-8">
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 overflow-auto">
      ...
      {showSuccess && (
        <div className="fixed top-4 sm:top-8 left-1/2 -translate-x-1/2 max-w-[90vw] sm:max-w-md bg-green-500 text-white px-6 sm:px-12 py-4 sm:py-6 rounded-xl sm:rounded-2xl shadow-2xl font-bold z-50 flex items-center justify-center gap-2 sm:gap-3 text-sm sm:text-base">
