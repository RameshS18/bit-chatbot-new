...
const LandingPage = () => {
  ...
  // ========================================================================================
  // [COMMENTED OUT] OTP request function — kept for future re-enablement
  // ========================================================================================
  ...
  // ========================================================================================
  // [NEW] Direct login submit — no OTP verification, calls /api/direct-login
  // ========================================================================================
  const handleSubmit = async () => {
    ...
    try {
      ...
      // [COMMENTED OUT] OTP validation — no longer needed for direct login
      // if (!otp || otp.length !== 6) {
  ...
  // ========================================================================================
  // [COMMENTED OUT] Original OTP-based handleSubmit — kept for future re-enablement
  // ========================================================================================
  // const handleSubmit_OTP = async () => {
  //   if (!isStepValid()) return;
  //   setError('');
  //   setIsLoading(true);
  //   try {
  ...
  const handleNext = () => {
    ...
    // [COMMENTED OUT] OTP request at step 3
    // if (currentStep === 3) {
    //   handleRequestOtp();
  ...
  const renderStep = () => {
    ...
    switch (currentStep) {
      ...
      //   );
      // ========================================================================================
      // [COMMENTED OUT] OTP Step — kept for future re-enablement
      // ========================================================================================
      // case 4:
      //   return (
      //     <div>
  ...
  // [COMMENTED OUT] OTP requesting state — no longer needed for direct login
